  ...
  return (
    <div className="mb-[4rem] md:mb-[8rem]">
      ...
      <p className=" text-[#aaaaaa] font-normal w-[80%] text-[17px] opacity-80">
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cum totam nisi
        odit sed aliquam ut quaerat dolore maxime voluptate quo, iste
        repellendus veritatis iusto unde?
      </p>
    </div>
  );
};

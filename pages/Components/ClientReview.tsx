  ...
  return (
    <div className="flex flex-col text-center justify-center">
      ...
      <p className="text-[16px] text-white opacity-50 w-[90%] md:w-[50%] mx-auto ">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum nam earum
        porro itaque doloremque rerum dolores in vitae placeat quia. Omnis
        quibusdam ipsam magnam iure?
      </p>
    </div>
  );
};
